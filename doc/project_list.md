...
- Produce no bets yet unless explicitly separated.
...
## Phase 11 — Betting and wallet strategy
...
### 11B — Bet decision layer

- Keep prediction confidence separate from bet decision.
- Start with flat-bet evaluation.
...
- Betting strategy is not promoted until prediction quality is proven.
...
- Repository write actions from the assistant side are not proven because prior write attempts were blocked before GitHub accepted or rejected them.
