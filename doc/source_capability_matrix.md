...
|---|---|---:|---:|---:|---:|---|---|---|---|
| Game schedule | MLB data / MLB Stats API | Not proven | Not proven | Not proven | Not proven | Not proven | UNKNOWN | Raw response sample, timestamp behavior, game ID fields | UNPROVEN |
| Canonical game IDs | MLB data / MLB Stats API | Not proven | Not proven | Not proven | Not proven | Not proven | UNKNOWN | Raw schedule response and ID mapping sample | UNPROVEN |
