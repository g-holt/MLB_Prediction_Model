...
|---|---|---:|---:|---:|---:|---|---|---|---|
| Game schedule | MLB Stats API schedule endpoint | Historical response sample proven; future schedule probe proven | Future-date pregame behavior partially proven; issued/as-of timestamp not proven | N/A for schedule identity; historical raw responses require score-blind filtering | No login/API key observed in audits | JSON | HIGH | Merged audits: historical 2024-04-01 and future probe 2026-06-28 to 2026-07-27; score-blind filter contract documented; initial implementation tests accepted; as-of timestamp behavior still required | UNPROVEN |
| Canonical game IDs | MLB Stats API schedule endpoint | gamePk/gameGuid fields proven in historical sample; future game IDs observed in probe | Future-date game identity partially proven; issued/as-of timestamp not proven | N/A for schedule identity; historical raw responses require score-blind filtering | No login/API key observed in audits | JSON | HIGH | Merged audits: historical 2024-04-01 and future probe 2026-06-28 to 2026-07-27; ID mapping contract documented; initial implementation tests accepted; as-of timestamp behavior and downstream crosswalks still required | UNPROVEN |
